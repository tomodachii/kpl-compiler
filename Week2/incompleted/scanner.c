...
Token *getToken(void)
{
  ...
  case CHAR_PLUS:
    ...
    {
      return token = makeToken(SB_PLUS, ln, cn);
    }
  case CHAR_MINUS:
    ln = lineNo;
    cn = colNo;
    ...
    {
      return token = makeToken(SB_MINUS, ln, cn);
    }
  case CHAR_TIMES:
    ln = lineNo;
    cn = colNo;
    ...
    {
      return token = makeToken(SB_TIMES, ln, cn);
    }
  case CHAR_SLASH:
    ln = lineNo;
    cn = colNo;
    ...
    {
      return token = makeToken(SB_SLASH, ln, cn);
    }
  ///////////////////////
  case CHAR_LT:
    ln = lineNo;
